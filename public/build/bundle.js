...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    exports.IS_PRODUCTION = "production" === 'production';
    });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span = element("span");
    			t4 = text(t4_value);
    			add_location(h1, file, 19, 1, 408);
    			add_location(button, file, 20, 2, 430);
    			add_location(span, file, 21, 1, 487);
